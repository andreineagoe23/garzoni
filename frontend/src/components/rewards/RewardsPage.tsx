  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`rounded-3xl border border-[color:var(--color-border-default)]  backdrop-blur-sm px-5 py-4 text-sm text-content-muted shadow-inner shadow-[color:var(--shadow-color)] transition-transform ${
