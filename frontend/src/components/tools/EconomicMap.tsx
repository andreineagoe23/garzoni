...
const EconomicMap = () => {
  ...
  return (
    <section className="space-y-3 min-w-0 w-full">
      <div
        ref={containerRef}
        className="rounded-2xl sm:rounded-3xl border border-[color:var(--color-border-default)] bg-surface-card p-2 shadow-xl shadow-[color:var(--shadow-color,rgba(0,0,0,0.1))] overflow-hidden w-full max-w-full"
