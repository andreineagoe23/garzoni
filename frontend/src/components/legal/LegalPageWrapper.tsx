...
export default function LegalPageWrapper({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <footer
        className="mt-auto border-t border-[color:var(--color-border-default)] px-4 py-6"
      ...
      >
        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-4">
            <Link
              to="/"
              className="text-sm font-semibold text-[color:var(--color-brand-primary)] hover:underline"
            >
