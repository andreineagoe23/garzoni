  ...
  return (
    <>
      ...
      >
        ...
        <h3>
          {t("legal.cookiePolicy.sections.sessionPersistent.sessionTitle")}
        </h3>
        ...
        <p>
          {t("legal.cookiePolicy.sections.sessionPersistent.persistentBody")}
        </p>
        ...
        <ul>
          <li>
            <strong>
              {t(
                "legal.cookiePolicy.sections.categories.items.necessary.label"
              )}
            </strong>{" "}
          ...
          <li>
            <strong>
              {t(
                "legal.cookiePolicy.sections.categories.items.preference.label"
              )}
            </strong>{" "}
          ...
          <li>
            <strong>
              {t(
                "legal.cookiePolicy.sections.categories.items.analytics.label"
              )}
            </strong>{" "}
          ...
          <li>
            <strong>
              {t(
                "legal.cookiePolicy.sections.categories.items.marketing.label"
              )}
            </strong>{" "}
