...
const MASCOT_MEDIA: Record<MascotType, { image: string; alt: string }> = {
  owl: { image: `${MEDIA_BASE}/media/mascots/monevo-owl.png`, alt: "Owl mascot" },
  bull: { image: `${MEDIA_BASE}/media/mascots/monevo-bull.png`, alt: "Bull mascot" },
  bear: { image: `${MEDIA_BASE}/media/mascots/monevo-bear.png`, alt: "Bear mascot" },
};
