  ...
  return (
    <div className={className}>
      {scriptReady && initialized ? (
        ...
        <div
          className="flex h-11 w-full items-center justify-center rounded-lg border border-[color:var(--color-border-default)] bg-[color:var(--color-surface-card)] text-sm text-content-muted"
          aria-hidden="true"
        >
          …
        </div>
