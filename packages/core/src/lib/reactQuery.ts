...
export const queryKeys = {
  ...
  duelsActive: () => ["duelsActive"] as const,
  duelsHistory: () => ["duelsHistory"] as const,
  duelDetail: (id: string | number) => ["duel", id] as const,
  friendActivityFeed: () => ["friendActivityFeed"] as const,
  friendSuggestions: () => ["friendSuggestions"] as const,
  userSearch: (q: string) => ["userSearch", q.toLowerCase()] as const,
