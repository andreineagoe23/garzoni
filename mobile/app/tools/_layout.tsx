...
export default function ToolsLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name="basic-finance/index"
        options={{ title: "Basic Finance Tools" }}
      />
      <Stack.Screen
        name="financial-goals/index"
        options={{ title: "Financial Goals" }}
      />
      <Stack.Screen
        name="currency-tools/index"
        options={{ title: "Currency Tools" }}
      />
      <Stack.Screen
        name="financial-sandbox/index"
        options={{ title: "Financial Sandbox" }}
      />
      <Stack.Screen
        name="news-calendars/index"
        options={{ title: "Economic Calendar" }}
      />
