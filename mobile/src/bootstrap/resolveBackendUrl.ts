...
/**
 * API base URL for native: prefer Metro-inlined env (lets a local dev override the baked
 * EAS value), then `app.config.js` extra. Must be the Django API origin; `/api` is appended
 * by @garzoni/core if missing.
 */
