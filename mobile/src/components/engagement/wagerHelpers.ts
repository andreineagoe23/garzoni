/**
 * Pure date-math helpers for Streak Wagers (see StreakWagerCard). Kept
 * separate and dependency-free so the countdown/preview-deadline logic is
 * unit-testable without rendering native components.
 *
