...
except ModuleNotFoundError:  # compatibility for environments with django-ckeditor-5 only
    from django_ckeditor_5 import fields as ckeditor5_fields

    class ckeditor_fields:  # noqa: N801
        RichTextField = ckeditor5_fields.CKEditor5Field
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("detailed_content", ckeditor_fields.RichTextField()),
                (
                    "image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("text_content", ckeditor_fields.RichTextField(blank=True, null=True)),
                ("video_url", models.URLField(blank=True, null=True)),
                (
                    "exercise_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        through="core.SectionCompletion",
                        to="core.lessonsection",
                    ),
                ),
                (
