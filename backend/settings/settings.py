...
AI_TUTOR_THROTTLE_RATE_FREE = os.getenv(
    "AI_TUTOR_THROTTLE_RATE_FREE", os.getenv("OPENROUTER_THROTTLE_RATE_FREE", "30/min")
)
AI_TUTOR_THROTTLE_RATE_PREMIUM = os.getenv(
    "AI_TUTOR_THROTTLE_RATE_PREMIUM",
    os.getenv("OPENROUTER_THROTTLE_RATE_PREMIUM", "120/min"),
)
...
OPENAI_CACHE_TTL_SECONDS = int(
    os.getenv("OPENAI_CACHE_TTL_SECONDS", os.getenv("OPENROUTER_CACHE_TTL_SECONDS", "0"))
)
OPENAI_IDEMPOTENCY_TTL_SECONDS = int(
    os.getenv(
        "OPENAI_IDEMPOTENCY_TTL_SECONDS",
        os.getenv("OPENROUTER_IDEMPOTENCY_TTL_SECONDS", "120"),
    )
)
...
OPENAI_MAX_PROMPT_CHARS = int(
    os.getenv("OPENAI_MAX_PROMPT_CHARS", os.getenv("OPENROUTER_MAX_PROMPT_CHARS", "4000"))
)
OPENAI_MAX_MESSAGES = int(
    os.getenv("OPENAI_MAX_MESSAGES", os.getenv("OPENROUTER_MAX_MESSAGES", "30"))
)
OPENAI_MAX_MESSAGE_CHARS = int(
    os.getenv("OPENAI_MAX_MESSAGE_CHARS", os.getenv("OPENROUTER_MAX_MESSAGE_CHARS", "2000"))
)
OPENAI_MAX_TOKENS = int(os.getenv("OPENAI_MAX_TOKENS", os.getenv("OPENROUTER_MAX_TOKENS", "512")))
OPENAI_ALLOWED_MODELS_CSV = env_csv(
    "OPENAI_ALLOWED_MODELS_CSV",
    default=["gpt-5-nano", "gpt-5-mini"],
)

# Legacy OpenRouter compatibility aliases (safe during migration).
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "").strip()
OPENROUTER_MAX_PROMPT_CHARS = OPENAI_MAX_PROMPT_CHARS
OPENROUTER_MAX_MESSAGES = OPENAI_MAX_MESSAGES
OPENROUTER_MAX_MESSAGE_CHARS = OPENAI_MAX_MESSAGE_CHARS
OPENROUTER_MAX_TOKENS = OPENAI_MAX_TOKENS
OPENROUTER_ALLOWED_MODELS_CSV = OPENAI_ALLOWED_MODELS_CSV
