...
urlpatterns = [
    ...
    path("paper-trade/buy/", PaperTradeBuyView.as_view(), name="paper-trade-buy"),
    path("asset-search/", AssetSearchView.as_view(), name="asset-search"),
    path("market/search/", MarketSearchView.as_view(), name="market-search"),
    path("market/quotes/", MarketBatchQuotesView.as_view(), name="market-batch-quotes"),
